...
INSERT INTO public.posts(billboard_id, comments_enabled, created_at, description, image, title, updated_at, user_id) VALUES('2', true, current_timestamp, 'Horarios de segundo', 'https://www.mollmanoutdoor.com/wp-content/uploads/2016/08/happy-billboard-min.jpg', 'Horarios 2', NULL, '3');
...
INSERT INTO public.posts(billboard_id, comments_enabled, created_at, description, image, title, updated_at, user_id) VALUES('3', true, current_timestamp, 'Horarios de tercero', 'https://www.mollmanoutdoor.com/wp-content/uploads/2016/08/happy-billboard-min.jpg', 'Horarios 3', NULL, '3');
...
INSERT INTO public.posts(billboard_id, comments_enabled, created_at, description, image, title, updated_at, user_id) VALUES('4', true, current_timestamp, 'Horarios de cuarto', 'https://www.mollmanoutdoor.com/wp-content/uploads/2016/08/happy-billboard-min.jpg', 'Sistemas Operativos', NULL, '3');
INSERT INTO public.posts(billboard_id, comments_enabled, created_at, description, image, title, updated_at, user_id) VALUES('4', true, current_timestamp, 'La continuacion de ISO', 'https://www.mollmanoutdoor.com/wp-content/uploads/2016/08/happy-billboard-min.jpg', 'Sistemas Operativos', NULL, '3');
INSERT INTO public.posts(billboard_id, comments_enabled, created_at, description, image, title, updated_at, user_id) VALUES('4', true, current_timestamp, 'Aca se pone bueno', 'https://www.mollmanoutdoor.com/wp-content/uploads/2016/08/happy-billboard-min.jpg', 'Laboratorio de Software', NULL, '3');
INSERT INTO public.posts(billboard_id, comments_enabled, created_at, description, image, title, updated_at, user_id) VALUES('5', true, current_timestamp, 'Horarios de quinto', 'https://www.mollmanoutdoor.com/wp-content/uploads/2016/08/happy-billboard-min.jpg', 'Diseño de Experiencia de Usuario', NULL, '3');
INSERT INTO public.posts(billboard_id, comments_enabled, created_at, description, image, title, updated_at, user_id) VALUES('5', true, current_timestamp, 'Interesante', 'https://www.mollmanoutdoor.com/wp-content/uploads/2016/08/happy-billboard-min.jpg', 'Diseño de Experiencia de Usuario', NULL, '3');
INSERT INTO public.posts(billboard_id, comments_enabled, created_at, description, image, title, updated_at, user_id) VALUES('5', true, current_timestamp, 'Por fin la tesis !!!', 'https://www.mollmanoutdoor.com/wp-content/uploads/2016/08/happy-billboard-min.jpg', 'Tesina de Licenciatura en Informática', NULL, '3');
